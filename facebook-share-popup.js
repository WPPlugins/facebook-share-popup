...
DialogWrapper.prototype = {
  ...
  _generateDialog: function(title,content,okbutton,cancelbutton) {
    if(!this.dom) {
      ...
      this.dom.dialog_title.className = 'sln_dialog_title';
      this.dom.dialog_inner.appendChild(this.dom.dialog_title);
      
      this.dom.dialog_content = document.createElement('div');
      this.dom.dialog_content.className = 'sln_dialog_content';
      this.dom.dialog_content.id = 'sln_dialog_content';
      ...
      this.dom.dialog_button_ok.className = 'sln_button sln_dialog_button sln_button_mode sln_ok';
      ...
      this.dom.dialog_button_cancel.className = 'sln_button_ignore sln_dialog_button sln_button_mode sln_cancel';
      ...
      this.dom.overlay.className = 'sln_dialog_overlay';
