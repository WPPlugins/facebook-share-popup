<?php
/*
Plugin Name: Facebook Share Popup
Version:     1.0.1
...
function fblpsn_options_page()
{
	...
	<h2>Facebook Share Popup Options</h2>
	ver 1.0.1
...
?>
<script type="text/javascript" src="<?php echo WP_PLUGIN_URL;?>/facebook-share-popup/facebook-share-popup.js"></script>
...
function showPopUpPrompt(){
	...
	dlg.dom.dialog_button_ok.className = 'sln_button_large';
	dlg.dom.dialog_button_cancel.className = 'sln_button_ignore sln_button_ignore_left';
...
.sln_smalldialog_inner, .sln_largedialog_inner {	
...
function fblpsn_adminmenu()
{
	if (function_exists('add_options_page')) {	
		add_options_page('Facebook Share Popup', 'Facebook Share Popup', 9, basename(__FILE__),'fblpsn_options_page');
	}
}
...
function fblpsn_plugpage( $links,$plugin ) {
	...
	{
		$links[] = '<a href="/wp-admin/options-general.php?page=facebook-share-popup.php">Settings</a>';
